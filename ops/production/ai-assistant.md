...
history deletion and the free-account 10th/11th request boundary at `https://REPLACE_PRODUCTION_ORIGIN` (the current deployment's value is kept in the deployment-local status snapshot, not in the repository).
