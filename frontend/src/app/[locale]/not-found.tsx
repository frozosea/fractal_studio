...
export default async function NotFound() {
  ...
  return (
    <div className="public-instrument flex min-h-[100dvh] flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="mt-6 text-xl font-light tracking-tight text-ink/90">{t("title")}</h1>
      <p className="mt-3 max-w-md text-sm leading-relaxed text-ink/50">{t("description")}</p>
