...
class ComputeNode(Base):
    ...
    max_cpu_slots: Mapped[int] = mapped_column(Integer, default=1)
    max_gpu_slots: Mapped[int] = mapped_column(Integer, default=1)
    max_cpu_preview_slots: Mapped[int] = mapped_column(Integer, default=2)
    max_gpu_preview_slots: Mapped[int] = mapped_column(Integer, default=2)
